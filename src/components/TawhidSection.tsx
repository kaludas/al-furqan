        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <GlassCard glow>
            <div className="text-center mb-6">
              ...
              <p className="font-display text-2xl text-foreground">{t('tawhid.oneness')}</p>
            </div>
          ...
          <GlassCard>
            <div className="text-center mb-6">
              ...
              <p className="font-display text-2xl text-foreground">{t('tawhid.shirk')}</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-foreground font-medium">{t('tawhid.reservedKnowledge')}</h4>
                </div>
                <p className="text-muted-foreground text-sm">
                  {t('tawhid.reservedKnowledgeDesc')}
                </p>
              </div>
        ...
        <GlassCard>
          ...
          <div className="mt-8 p-4 rounded-xl bg-primary/10 border border-primary/20 text-center">
            <p className="text-foreground">
              <strong className="text-primary">{t('tawhid.quranDeclares')}</strong> {t('tawhid.quranVerse')}
